...
Sprite_Character.prototype.updateVisibility = function() {
	...
	if(this._character._randomType){
			...
			if (delX * delX + delY * delY <= 1){
				if(this._character._randomType > 1) this._character._opacity += Math.min(80,255 - this._character._opacity);
				else this._character._opacity += Math.min(80,255 - this._character._opacity);
				return;
			}
			...
			if(!this.playerSee() && extra < 50){
				...
				if(this._character._randomType > 1){
					if(this._character._opacity == 0 && extra >= Math.random() * 50)  this._character._opacity += Math.min(60,255 - this._character._opacity);
					else this._character._opacity += Math.min(1,255 - this._character._opacity);
				}
